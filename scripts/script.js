...
function calc()
{
	...
	//document.getElementById('carcass_list').innerHTML += "<input readonly name = 'c_colour' type ='hidden' value = "+"'"+c_colour+ "'"+"></input></br>";
